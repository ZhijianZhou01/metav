...
The viral taxonomy information is used to classfy viral reads, this repository provides the [species_information-2021-05-20.txt] that we organize ourselves. If you want to add information, keep it in the same format.
